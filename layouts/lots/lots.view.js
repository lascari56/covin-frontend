...
export default function LotsView({children, data, loading, fullItemSelected, formikMeta, page, pageCount, meta, LeftComponent, onChangePage, onPageMore, onChangeFulLotId}) {
  return (
    <S.Container>
